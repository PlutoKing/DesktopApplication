...
using LF.Algorithm;
using LF.Algorithm.GeneticAlgorithm;
...
namespace LF.UnmannedAerialVehicle
{
    ...
    /// 二维地图
    /// </summary>
    public class LFMap2D:INotifyPropertyChanged
    {
        #region Fields
        /// <summary>
        /// 定义属性改变事件
        ...
        private List<LFObstacle2D> _obstacle2DList = new List<LFObstacle2D>();
        ...
        /// 障碍物列表
        /// </summary>
        public List<LFObstacle2D> Obstacle2DList { get => _obstacle2DList; set => _obstacle2DList = value; }
        ...
        public void SimplyMap(LFLine2D line, double offset)
        {
            ...
            List<LFObstacle2D> otherList = new List<LFObstacle2D>();
            ...
            else
            {
                ...
                foreach (LFObstacle2D ob in otherList)
                {
        ...
        {
            foreach (LFObstacle2D ob in _obstacle2DList)
            {
        ...
        /// <returns></returns>
        public List<LFObstacle2D> GetSubObscale2DList(int[] index)
        {
            List<LFObstacle2D> obList = new List<LFObstacle2D>();
